            ...
            <tbody class="search-result">
                <?php foreach($products as $product): ?>
                    <tr data-key="<?php echo $product->id; ?>">
                        ...
                        <td>
                            <a href="/product/manage/view?id=<?php echo $product->id; ?>" title="View" aria-label="View" data-pjax="0"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;&nbsp;&nbsp;
                            <a href="/product/manage/update?id=<?php echo $product->id; ?>" title="Update" aria-label="Update" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;&nbsp;
                            <a href="/product/manage/delete?id=<?php echo $product->id; ?>" title="Delete" aria-label="Delete" data-pjax="0" data-confirm="Are you sure you want to delete this item?" data-method="post"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
